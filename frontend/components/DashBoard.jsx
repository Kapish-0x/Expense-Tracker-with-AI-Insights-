...
//   // SAVINGS ALERT LOGIC
//   const isSavingsLow = currentUser?.savingsAlertEnabled && (savings < (currentUser?.minSavings || 0));
...
//       {/* SAVINGS BREACH ALERT BANNER */}
//       {isSavingsLow && (
//         <div className="bg-rose-50 border border-rose-100 p-6 rounded-[2rem] flex items-center gap-4 animate-bounce-subtle">
//           <div className="p-3 bg-rose-100 text-rose-600 rounded-2xl">
//             <AlertTriangle size={24} />
//           </div>
//           <div>
//             <h4 className="text-rose-900 font-bold text-sm uppercase tracking-wider">Financial Guardrail Tripped</h4>
//             <p className="text-rose-700/80 text-sm">Your net savings (₹{savings.toLocaleString("en-IN")}) have fallen below your set floor of ₹{currentUser?.minSavings?.toLocaleString("en-IN")}.</p>
//           </div>
//         </div>
//       )}
...
const downloadPDF = () => {
  ...
  // SAVINGS ALERT LOGIC (Checking both Toggle Status and Threshold)
  const isSavingsLow = 
        ...
        <div className="bg-rose-50 border border-rose-100 p-6 rounded-4xl flex items-center gap-4 animate-bounce-subtle">
          ...
          <div>
            ...
            <p className="text-rose-700/80 text-sm">
              Your net savings (₹{savings.toLocaleString("en-IN")}) have fallen below your set floor of ₹{currentUser?.minSavings?.toLocaleString("en-IN")}.
            </p>
          </div>
        </div>
      )}
