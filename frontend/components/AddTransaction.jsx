      ...
      <div className="relative bg-white w-full max-w-lg rounded-[2.5rem] p-10 shadow-[0_20px_50px_rgba(0,0,0,0.1)] animate-in fade-in zoom-in duration-500 border border-slate-100">
        ...
        <header className="mb-10 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-2">
             ...
             <p className="text-slate-400 text-[11px] font-bold uppercase tracking-[2px]">Authenticated: {currentUser?.name || "User"}</p>
          </div>
        </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <input 
                ...
                className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm focus:ring-4 focus:ring-slate-50 focus:border-slate-400 outline-none transition-all placeholder:text-slate-300"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <select 
                  className="w-full appearance-none bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm focus:ring-4 focus:ring-slate-50 focus:border-slate-400 outline-none cursor-pointer transition-all"
                  value={formData.type}
            ...
            <div className="space-y-1.5">
              ...
              <input 
                ...
                type="number" 
                placeholder="0.00"
                className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm font-semibold focus:ring-4 focus:ring-slate-50 focus:border-slate-400 outline-none transition-all placeholder:text-slate-300"
          ...
          <div className="space-y-1.5">
            ...
            <textarea 
              ...
              className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm focus:ring-4 focus:ring-slate-50 focus:border-slate-400 outline-none resize-none h-24 transition-all placeholder:text-slate-300"
          ...
          <button 
            disabled={loading}
            type="submit" 
            className="w-full bg-slate-950 text-white py-5 rounded-2xl font-semibold text-sm hover:bg-slate-800 transition-all active:scale-[0.98] mt-4 disabled:opacity-50 flex items-center justify-center gap-3 shadow-lg shadow-slate-100"
          >
            {loading ? (
